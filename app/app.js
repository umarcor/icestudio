...
connectors.ice = function(sourcePoint, targetPoint, vertices) {
  var points = [];
...
shapes.ice = {};
shapes.ice.Model = shapes.basic.Generic.extend({
  markup:
    '<g class="rotatable">\
             <g class="scalable">\
               <rect class="body"/>\
...
shapes.ice.ModelView = dia.ElementView.extend({
  template: "",
...
shapes.ice.Generic = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Generic"
    },
    shapes.ice.Model.prototype.defaults
  )
});

shapes.ice.GenericView = shapes.ice.ModelView.extend({
  // Image comments:
  ...
  initialize: function() {
    shapes.ice.ModelView.prototype.initialize.apply(this, arguments);
...
shapes.ice.Input = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Input",
      size: {
...
shapes.ice.Output = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Output",
      size: {
...
shapes.ice.InputLabel = shapes.ice.Model.extend({
  markup:
    '<g class="rotatable">\
             <g class="scalable">\
               <rect class="body" />\
...
shapes.ice.OutputLabel = shapes.ice.Model.extend({
  markup:
    '<g class="rotatable">\
             <g class="scalable">\
               <rect class="body"/>\
...
shapes.ice.IOView = shapes.ice.ModelView.extend({
  initialize: function() {
    _.bindAll(this, "updateBox");
    dia.ElementView.prototype.initialize.apply(this, arguments);
...
shapes.ice.Constant = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Constant",
      size: {
...
shapes.ice.ConstantView = shapes.ice.ModelView.extend({
  initialize: function() {
    _.bindAll(this, "updateBox");
    dia.ElementView.prototype.initialize.apply(this, arguments);
...
// Memory block
shapes.ice.Memory = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Memory",
      size: {
...
shapes.ice.MemoryView = shapes.ice.ModelView.extend({
  initialize: function() {
    _.bindAll(this, "updateBox");
    dia.ElementView.prototype.initialize.apply(this, arguments);
...
// Code block
shapes.ice.Code = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Code",
      size: {
...
shapes.ice.CodeView = shapes.ice.ModelView.extend({
  initialize: function() {
    _.bindAll(this, "updateBox");
    dia.ElementView.prototype.initialize.apply(this, arguments);
...
// Info block
shapes.ice.Info = shapes.ice.Model.extend({
  defaults: util.deepSupplement(
    {
      type: "ice.Info",
      size: {
...
shapes.ice.InfoView = shapes.ice.ModelView.extend({
  initialize: function() {
    _.bindAll(this, "updateBox");
    dia.ElementView.prototype.initialize.apply(this, arguments);
